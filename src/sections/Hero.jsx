          ...
          <div className="space-y-8">
            ...
            <div className="space-y-4">
              ...
              <p className="text-lg text-muted-foreground max-w-lg animate-fade-in animation-delay-200">
                ...
                par la création d'applications web et mobiles modernes. 
            ...
            <div className="flex items-center gap-4 animate-fade-in animation-delay-400">
              ...
              {[
                { icon: FiGithub, href: "https://github.com/Seydinaomar88", label: "GitHub" },
                { icon: FiLinkedin, href: "https://linkedin.com/in/omar-cisse", label: "LinkedIn" },
                // { icon: FiTwitter, href: "https://twitter.com/omar", label: "Twitter" },
              ].map((social, idx) => (
                <a
                  key={idx}
                  href={social.href}
